...
export const CATEGORIES: Record<Exclude<CategoryKey, CategoryKey.FAVORITES>, CategoryInfo> = {
  [CategoryKey.FAIRY_TALES]: {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-20 w-24" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  [CategoryKey.MUSIC]: {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-20 w-24" fill="currentColor" viewBox="0 0 24 24">
  ...
  [CategoryKey.CARTOONS]: {
    ...
    icon: (
       <svg xmlns="http://www.w3.org/2000/svg" className="h-20 w-24" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
